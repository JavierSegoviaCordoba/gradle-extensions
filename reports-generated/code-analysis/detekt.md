...
* 1,419 lines of code (loc)

* 1,163 source lines of code (sloc)

* 811 logical lines of code (lloc)

* 1 comment lines of code (cloc)

* 156 cyclomatic complexity (mcc)
...
generated with [detekt version 1.22.0](https://detekt.dev/) on 2023-03-09 16:22:28 UTC
